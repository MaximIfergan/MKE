...
import pandas as pd
import random
from Dataset.DatasetBuilder import FEW_SHOT
random.seed(18)
...
class KnowledgeEvaluator:
    ...
    def eval(self, n_samples=None, fewshot=False):
        self.model.eval()
        ...
        for i, sample in tqdm(enumerate(dataset), total=len(dataset)):
            ...
            for lang in sample["prompt"].keys():
                ...
                prompt = FEW_SHOT["birth_year"][lang] + prompt if fewshot else prompt
