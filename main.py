...
from LingualKnowledgeTranfer.model_editor import KnowledgeEditor
...
if __name__ == "__main__":
    ...
    # ke = KnowledgeEvaluator(model_name="bigscience/bloom-7b1", exp_name="Fewshot_Fix")
    # # Fewshot_Fix evaluation results: EM 1.3332846288720046,  F1: 3.4904284137188792
    # ke.eval()
    # ke.save_results()
    ke = KnowledgeEditor(model_name="bigscience/bloom-7b1", exp_name="all_2", eval_results_path="Fewshot_Fix_eval_res.csv")
